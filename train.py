...
from model import  Resnet50FPN,VGG16FPN,CountRegressor,weights_normal_init
...
# The path decalaration of this model

#dataPath_mine = os.path("C:\\Users\\Shan\\OneDrive\\Desktop\\Final_Project\\CountIT_Learn\\LearningToCountEverything\\train.py")



parser = argparse.ArgumentParser(description="Few Shot Counting Evaluation code")
parser.add_argument("-dp", "--data_path", type=str, default='C:\\Users\\acer\\Documents\\DONT TOUCH OR DELETE\\CountIT_FinalProject\\LearningToCountEverything\\FSC147_384_V2\\', help="Path to the FSC147 dataset")
parser.add_argument("-o", "--output_dir", type=str,default=".\\logsSave", help="C:\\Users\\acer\\Documents\\DONT TOUCH OR DELETE\\CountIT_FinalProject\\LearningToCountEverything\\logs")
parser.add_argument("-ts", "--test-split", type=str, default='val', choices=["train", "test", "val"], help="what data split to evaluate on on")
parser.add_argument("-ep", "--epochs", type=int,default=2, help="number of training epochs")
...
data_split_file = data_path + 'Train_Test_Val_FSC_147_3k.json'
...
for epoch in range(0,args.epochs):
    ...
    if best_mae >= val_mae:
        best_mae = val_mae
        best_rmse = val_rmse
        model_name = args.output_dir + '\\' + "FamNet2ep.pth"
